    ...
    <div>
      ...
      <main className='p-6'>
        <div className='flex justify-between items-center mb-8'>
          <div className='h-8 mb-18px'>
            <h2 className='text-2xl font-medium '>Tu rendimiento</h2>
            <p className='mb-6 text-8 font-light leading-4'>
        ...
        <div>
          <div>
            ...
            <p className='text-xs mb-2 font-light mb-9px'>Seguí tus avances</p>
          </div>
          <div className='bg-gray1000 mb-24px shadow-custom h-20 p-3 rounded-3xl h-custom backdrop-blur-md '>
