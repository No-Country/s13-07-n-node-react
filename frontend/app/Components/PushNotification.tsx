  ...
  return (
    <div className='flex justify-center items-center w-full absolute top-0 right-0 left-0'>
        ...
        <div className="flex items-center mb-3">
            <span className="mb-1 text-sm font-semibold text-gray-900">Tienes una nueva notificación</span>
        ...
        <div className="flex items-center">
            <div className="relative inline-block shrink-0">
                <Image className="w-12 h-12 rounded-full" src={logo} alt='avatar' />
            ...
            <div className="ms-3 text-sm font-normal">
                <div className="text-sm font-semibold text-gray-900">Spotter</div>
                <div className="text-sm font-normal">pronto vence tu membresía</div> 
                <span className="text-xs font-medium text-primaryDefault">Ahora</span>   
            </div>
        </div>
    </div>
    </div>
